...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    Command auto4 = Autos.SmashAuto(m_DriveTrainSubsystem);
  ...
  private void configureBindings() {
    ...
    if (Robot.isSimulation()) {
      ...
      m_driverController.x().whileTrue(m_ArmSubsystem.armUp()).onFalse(m_ArmSubsystem.stopArm());
      m_driverController.a().whileTrue(m_ArmSubsystem.armDown()).onFalse(m_ArmSubsystem.stopArm());
    }
